...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Label("S0:"),
            dcc.Slider(id='S0', min=0, max=5*10**8, step=1, value=4*10**8,
                       marks={round(i, 2): f"{i:.2f}" for i in np.linspace(0,  5*10**8, 6)}),
            html.Label("I0:"),
            dcc.Slider(id='I0', min=0, max=1*10**8, step=0.1, value=1,
        ...
        html.Div([
            ...
            dcc.Slider(id='beta', min=0, max=5*10**-6, step=10**-6, value=4.2*10**-6,
