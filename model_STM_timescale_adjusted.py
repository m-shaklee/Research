...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Slider(id='delta', min=0, max=1*10**-6, step=0.5*10**-6, value=0.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 1e-6, 6)}),
            html.Label("δ_TN: Infected cell death by TN"),
            dcc.Slider(id='delta_N', min=0, max=1*10**-6, step=0.5*10**-6, value=0.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 1e-6, 6)}),
            html.Label("δ_STM: Infected cell death by STM"),
            dcc.Slider(id='delta_STM', min=0, max=1*10**-6, step=0.5*10**-6, value=0.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 1e-6, 6)}),
