...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Slider(id='delta', min=0, max=0.01, step=0.001, value=0.005,
                       marks={round(i, 2): f"{i:.2f}" for i in np.linspace(0, 0.01, 6)}),
            html.Label("δ_TN: Infected cell death by TN"),
            dcc.Slider(id='delta_N', min=0, max=0.01, step=0.001, value=0.005,
                       marks={round(i, 2): f"{i:.2f}" for i in np.linspace(0, 0.01, 6)}),
            html.Label("δ_STM: Infected cell death by STM"),
            dcc.Slider(id='delta_STM', min=0, max=0.01, step=0.001, value=0.005,
                       marks={round(i, 2): f"{i:.2f}" for i in np.linspace(0, 0.01, 6)}),
