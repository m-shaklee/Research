...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Slider(id='delta', min=0, max=5*10**-6, step=10**-6, value=1.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 5e-6, 6)}),
            html.Label("δ_TN: Infected cell death by TN"),
            dcc.Slider(id='delta_N', min=0, max=5*10**-6, step=10**-6, value=1.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 5e-6, 6)}),
            html.Label("δ_STM: Infected cell death by STM"),
            dcc.Slider(id='delta_STM', min=0, max=5*10**-6, step=10**-6, value=1.5*10**-6,
                       marks={i: f"{i:.0e}" for i in np.linspace(0, 5e-6, 6)}),
